         ...
         if(!OperatorStack.isEmpty()){
             if (OperatorStack.peek() == 29){
                 ...
                 if(tyRes != -1){
                    ...
                    OperandStack.push(-1);
                    listaErrores.add("Error found At line "+token.beginLine+", column "+token.beginColumn+"\u005cn Type mismatch.");
                 }
             }
         }
    jj_consume_token(SEMICOLON);
...
int iSize;
  ...
  static final public void VARS_AUX1_1(Objeto var, int cont) throws ParseException {
  ...
  static final public void MODULO() throws ParseException {
    ...
    identificador = jj_consume_token(ID);
            ...
            int i;
                ...
                if(end){
                    listaErrores.add("Error found At line "+token.beginLine+", column "+token.beginColumn+"\u005cn La funcion " + identificador.image + " Ya se declaro");
                }
...
int dir = 0;
    identificador = jj_consume_token(ID);
        ...
        if(!end){
            listaErrores.add("Error found At line "+token.beginLine+", column "+token.beginColumn+"\u005cn La funcion " + identificador.image + " invocada no se declaro");
        }
...
int cuadSize = cuadruplosArr.size(), opRes;
  ...
  static private boolean jj_3R_27() {
    if (jj_scan_token(cte_c)) return true;
    return false;
  }
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0xbc0,0x5f4,0x434,0x1000,0x8000000,0x18000000,0x7e00000,0x7e00000,0x60000,0x180000,0x40000,0x40040000,0x1000,0x0,0x4,0x8,0x200,0x20000000,0x20000000,0x0,0xbc0,0x0,0x1c0,0x40040000,0x0,0x40040000,0x1c0,0x40040000,0x20000,0x20000,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x40,0x40,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x5c,0x0,0x5c,0x0,0x0,0x40,0x0,0x0,0x1,0x0,0x1,0x0,0x5c,0x1,0x5c,0x0,0x7c,0x0,0x0,};
   }
